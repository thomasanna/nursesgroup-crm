...
<div class="box box-default">
  <div class="box-header with-border">
    <div class="pull-left">
        <h1 class="box-title">Archives</h1>
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive no-padding">
        <table class="table table-striped table-bordered table-hover"
              fetch="{{route('transportation.archives.data')}}"
              token="{{ csrf_token() }}">
          <thead>
            <tr>
              <th style="width:3%;">Trip No</th>
...
<script src="{{asset('public/js/pages/transportation/archives/index.js')}}"></script>
@endpush
@push('css')
