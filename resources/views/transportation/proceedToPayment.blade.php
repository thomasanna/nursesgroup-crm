...
<div class="box box-default m-t-10">
  <div class="box-body">
    <div class="pull-left">
        <h4 class="box-title">Record Payment Transport</h4>
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
          ...
          <div class='row reviewPayment'>
            ...
            <div class='col-sm-1 wdth4 allctTrip'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="order" disabled="disabled" type="text" value="{{$trip->order}}"  />
              </div>
            </div>
          </div>
          @endforeach
        ...
        <hr>
        <form action="{{route('transportation.proceed.payment.save')}}" method="post" >
        {!! csrf_field() !!}
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class='col-sm-2'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="aggreedAmount" disabled="disabled" type="text" value="{{$trip->aggreedAmount}}" />
              </div>
            </div>
          ...
          <option value="{{$taxYear->taxYearId}}">{{$taxYear->taxYearFrom}} - {{$taxYear->taxYearTo}}<option>
                       @endforeach
       </select>
              </div>
            </div>
            ...
            <div class='col-sm-1'>
              <div class='form-group'>
                  <label for="date">Payee Week</label>
                  <select name="payeeWeek"  class="form-control">
                          @for ($i = 1; $i < 53; $i++)
        ...
        <div class="box-footer">
          <input type="submit" class="btn btn-primary pull-right" value="Save for Later" autocomplete="off">
          @if($trip->taxYear && $trip->payeeWeek)
          <a href="{{route('transportation.proceed.payment.action',[$trip->clubId,$trip->date])}}" class="btn btn-success pull-right m-r-10">Proceed to Payment</a>
          @endif
        </div>
