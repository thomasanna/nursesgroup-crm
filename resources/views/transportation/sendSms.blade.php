...
@section('title','SMS Transportation')
@section('content')
<!-- Header Navigation -->
<div class="box box-default m-t-10">
  <div class="box-body">
    <div class="pull-left">
        <h4 class="box-title">Send Trip SMS</h4>
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
        ...
        <div class="box-body">
          <form action="{{route('transportation.send.trip.sms.action')}}" method="post" >
            {!! csrf_field() !!}
          <div class='row'>
            <div class='col-sm-10 m-l-10'>
              <div class='form-group'>
                  <label for="date" class="m-t-10">{{$driver->forname}} {{$driver->surname}} | {{$driver->mobile}} </label>
                  <textarea rows="15" name="sms" class="form-control m-t-25 ">{{$sms}}
                  </textarea>
              </div>
            </div>
