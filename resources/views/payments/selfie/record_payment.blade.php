...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      ...
      @else
      <a href="{{route('payment.selfie.ra.pdf',[$payments[0]->timesheet->paymentWeek,$payments[0]->booking->staff->staffId])}}" target="_blank"  class="btn btn-success">Download</a>
      @endif
      @if($from ==0)
      <a href="{{route('payment.selfie.ra.email')}}" class="btn btn-primary">Email</a>
      @else
      <a href="{{route('payment.selfie.ra.email',[$payments[0]->timesheet->paymentWeek,$payments[0]->booking->staff->staffId])}}" class="btn btn-primary">Email</a>
      @endif
      @if($from ==0)
      <a href="{{route('payment.selfie.week.review',[$payments[0]->timesheet->paymentWeek,$payments[0]->booking->staff->staffId])}}" class="btn btn-warning">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
        ...
        <div class="box-body">
          <div class="row">
            <form action="{{route('payment.selfie.ra.record.payment.action')}}" method="POST">
              {!! csrf_field() !!}
