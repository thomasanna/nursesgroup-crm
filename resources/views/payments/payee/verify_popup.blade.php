<div class="modal fade" id="payeeModalverfy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" action="{{route('payment.payee.verify')}}" single="{{route('payment.data.single')}}"  token="{{ csrf_token() }}">
   <div class="modal-dialog modal-950">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="exampleModalLabel">Paye Verification</h3>
            ...
            <div class='form-group'>
               <div class='col-sm-12 tmshtInfo'>
                  <div class='col-sm-2'>
                     ...
                     <div class="col-sm-8">
                      <p>:<span class="startTime" id="startTime"></span></p>
                     </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6 blueBg">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-3 pull-right">
                        <input class="form-control text-right otherPayAmount" type="text" name="otherPayAmount" id="otherPayAmount">
                     </div>
                  </div>
                     ...
                     <div class="col-sm-6">
                        <select class="form-control" id="sel1" name="paymentYear">
                          @foreach($taxYears as $year)
                            <option value="{{$year->taxYearId}}" selected >{{$year->taxYearFrom}} - {{$year->taxYearTo}}</option>
                          @endforeach
                        </select>
                     </div>
                  </div>
