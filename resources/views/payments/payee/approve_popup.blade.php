<div class="modal fade" id="approvePayeeModal" tabindex="-1" role="dialog" aria-hidden="true" action="{{route('payment.payee.approve')}}" single="{{route('payment.data.single')}}"  weekNum="{{$thisWeek->weekNumber}}" token="{{ csrf_token() }}">
   <div class="modal-dialog modal-950">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="exampleModalLabel">Paye Approval</h3>
            ...
            <div class="row">
               ...
               <div class="col-md-6 blueBg">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-3 pull-right">
                        <input class="form-control text-right otherPayAmount" type="text"  name="otherPayAmount" readonly="readonly">
                     </div>
                  </div>
            ...
            <div class="row m-t-5">
               ...
               <div class="col-md-6 blueBg h290">
                  ...
                  <!-- <div class="form-group row">
                     <label for="" class="col-sm-6 col-form-label">TS Link</label>
                     <div class="col-sm-5">
                        <input class="form-control text-right tsLink" type="text" readonly="readonly">
                     </div>
                     <div class="col-sm-1">
                        <button type="button" class="btn btn-warning copyToClipBoard">Copy ID</button>
                     </div>
