...
@section('title','PAYE Payments')
@section('content')
<!-- Header Navigation -->
<div class="box box-default">
  <div class="box-header with-border">
    <div class="pull-left" id="pageTitle">
        <h1 class="box-title">PAYE Payments - V & A</h1>
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive no-padding">
        <table class="table table-striped table-bordered table-hover"
              fetch="{{route('payment.payee.data.list')}}"
              token="{{ csrf_token() }}"
      ...
      <?php 
        ...
        $week = intval($weekNum);
      ?>
      <input type="hidden" name="hidWeekNum" value="{{$week}}">
      </div>
      <!-- /.box-body -->
    </div>
    <!-- /.box -->
...
<!-- Modal -->
@include('payments.payee.verify_popup')

<!-- Modal -->
@include('payments.payee.approve_popup')
...
<script src="{{ asset('public/js/pages/payments/payee.js') }}?{{time()}}"></script>
@endpush
@push('css')
