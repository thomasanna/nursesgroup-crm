...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      <a href="{{route('staffs.training.home',encrypt($training->staffId))}}" class="btn btn-warning">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('staffs.training.update')}}" method="post" accept="application/pdf, image/*" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <input type="hidden" name="trainingId" value="{{encrypt($training->staffTrainingId)}}">
        <div class="box-body">
          <div class='row'>
            <div class='col-sm-4'>
          ...
          <div class='row'>
            <div class='col-sm-4 pull-right'>
              <div class='form-group'>
                <a href="{{asset('storage/app/staff/staff_trainings/'.$training->documentFile)}}" target="_blank" class="btn btn-warning">View Certificate</a>
              </div>
            </div>
          </div>
          @endif
...
<script src="{{asset('public/js/pages/staffs/trainings/new.js')}}"></script>
@endpush
@push('css')
