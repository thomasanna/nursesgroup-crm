...
@section('title','Staff Trainings')
@section('content')
<!-- Header Navigation -->
<div class="box box-default">
  <div class="box-header with-border">
    <div class="pull-left">
        <h1 class="box-title">Staff Trainings</h1>
    ...
    <div class="pull-right">
        <a href="{{route('staffs.home.active',$searchKeyword)}}" class="btn btn-warning">
          ...
          Back</a>
        <a href="{{route('staffs.training.new',encrypt($staff->staffId))}}" class="btn btn-primary">
    ...
    <div class="pull-right m-r-10 w13">
      ...
      staff="{{encrypt($staff->staffId)}}">
        <option value="1" @if($staff->trainingProgress==1) selected="selected" @endif>To Be Started</option>
        <option value="2" @if($staff->trainingProgress==2) selected="selected" @endif>In Progress</option>
        <option value="3" @if($staff->trainingProgress==3) selected="selected" @endif>Completed</option>
      </select>
    </div>
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive no-padding trainings">
        <table class="table table-striped table-bordered table-hover"
              fetch="{{route('staffs.training.data')}}"
              token="{{ csrf_token() }}"
              staff="{{encrypt($staff->staffId)}}">
          <thead>
            <tr>
...
<script src="{{asset('public/js/pages/staffs/trainings/index.js')}}"></script>
@endpush
@push('css')
