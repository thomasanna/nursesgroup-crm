...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      <a href="{{route('staffs.training.home',encrypt($staff->staffId))}}" class="btn btn-warning">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('staffs.training.save')}}" method="post" accept="application/pdf, image/*" enctype="multipart/form-data">
        {!! csrf_field() !!}
          ...
          <div class='row'>
            ...
            <div class='col-sm-2'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="issueDate" token="{{ csrf_token() }}" action="{{route('staffs.training.get.training.course')}}"
