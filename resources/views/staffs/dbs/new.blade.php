...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      <a href="{{route('staffs.dbs.home',encrypt($staff->staffId))}}" class="btn btn-warning">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('staffs.dbs.save')}}" method="post" accept="application/pdf, image/*" enctype="multipart/form-data">
        {!! csrf_field() !!}
...
<script src="{{asset('public/js/pages/staffs/dbs/new.js')}}"></script>
@endpush
@push('css')
