...
@section('title','Staff References')
@section('content')
<!-- Header Navigation -->
<div class="box box-default">
  <div class="box-header with-border">
    <div class="pull-left">
        <h1 class="box-title">Staff References</h1>
    ...
    <div class="pull-right">
        <a href="{{route('staffs.home.active',$searchKeyword)}}" class="btn btn-warning">
          ...
          Back</a>
        <a href="{{route('staffs.references.new',encrypt($staff->staffId))}}" class="btn btn-primary">
    ...
    <div class="pull-right m-r-10 w13">
      ...
      staff="{{encrypt($staff->staffId)}}">
        <option value="1" @if($staff->referenceProgress==1) selected="selected" @endif>To Be Started</option>
        <option value="2" @if($staff->referenceProgress==2) selected="selected" @endif>In Progress</option>
        <option value="3" @if($staff->referenceProgress==3) selected="selected" @endif>Completed</option>
      </select>
    </div>
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive no-padding dbs">
        <table class="table table-striped table-bordered table-hover"
              fetch="{{route('staffs.references.data')}}"
              token="{{ csrf_token() }}"
              staffId="{{encrypt($staff->staffId)}}">
          <thead>
            <tr>
              ...
              <th style="width:5%;">Mode Of Reference</th>
...
<script src="{{asset('public/js/pages/staffs/references/index.js')}}"></script>
@endpush
@push('css')
