 <div class="col-md-6 bordrNice">
         <div class="row col-md-12">
            <div class="col-md-4">
               <div class="date">{{$nextMonth}}</div>
               <div class="m-t">
                  <span class="m-r-20">Number of HCA</span>
                  <span>:</span>
                  <span>{{array_sum($nextMonthBookHCAConfirmed)}}</span>
               </div>
               <div class="m-t">
                  <span class="m-r-20">Number of RGN</span>
                  <span>:</span>
                  <span>{{array_sum($nextMonthBookRGNConfirmed)}}</span>
               </div>
            </div>
         ...
         <div class="col-md-12" id="container1" action="{{route('unit.area.graph.current.month.bookings')}}" token="{{ csrf_token() }}" style="min-width: 310px; height: 300px; margin: 0 auto">
         </div>
      </div>
