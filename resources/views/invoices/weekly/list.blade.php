...
@section('title','Unit Bills - Weekly')
@section('content')
<!-- Header Navigation -->
<div class="box box-default">
  <div class="box-header with-border">
    <div class="pull-left" id="pageTitle">
        <h1 class="box-title">Unit Bills - Weekly</h1>
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive no-padding">
        <table class="table table-striped table-bordered table-hover"
              fetch="{{route('invoices.weekly.data')}}"
              token="{{ csrf_token() }}"
          ...
          <thead>
            <tr>
              ...
              <th style="width:7%;">Payee Week</th>
...
<script src="{{ asset('public/js/pages/invoices/weeklyList.js') }}"></script>
@endpush
@push('css')
