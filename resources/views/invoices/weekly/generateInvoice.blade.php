...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      @if($from ==0)
      <a href="{{route('invoices.weekly.pdf')}}" target="_blank" class="btn btn-success">Download</a>
      @else
      <a href="{{route('invoices.weekly.pdf',[$invoices[0]->weekNumbr,$invoices[0]->booking->unitId])}}" target="_blank" class="btn btn-success">Download</a>
      @endif

     <!--
      <a href="{{route('invoices.weekly.excel',[$invoices[0]->weekNumbr,$invoices[0]->booking->unitId])}}" class="btn btn-success">Download</a>
 -->      <a href="{{route('invoices.weekly.internal.excel',[$invoices[0]->weekNumbr,$invoices[0]->booking->unitId])}}" class="btn btn-danger">Internal</a>

      @if($from ==0)
      <a href="{{route('invoices.weekly.email')}}" class="btn btn-primary">Email</a>
      @else
      <a href="{{route('invoices.weekly.email',[$invoices[0]->weekNumbr,$invoices[0]->booking->unitId])}}" class="btn btn-primary">Email</a>
      @endif
      @if($from ==0)
      <a href="{{route('invoices.week.review',[$invoices[0]->weekNumbr,$invoices[0]->booking->unitId])}}" class="btn btn-warning">
