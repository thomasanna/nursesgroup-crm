      ...
      <!-- form start -->
        ...
        <div class="box-body">
          ...
          <div class="box-body" style="line-height: 26px;">
            ...
            <div class="col-sm-7 blueFont">JSS Healthcare Ltd, 20-22, Wenlock Road, London, N1 7GU, Reg No: 09846338</div>
        ...
        <div class="box-body">
          <div class="row">
            <form action="{{route('invoices.monthly.record.payment.action')}}" method="POST">
              {!! csrf_field() !!}
              ...
              <div class="col-sm-2 m-l-10">
                <div class="form-group">
                    ...
                    <input class="form-control" name="paymentDate" required type="text" @if($invoices[0]->paymentDate)
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <select name="bankId" class="form-control" required>
                    <option value="1" @if($invoices[0]->bankId == 1) selected="selected" @endif >Natwest</option>
                    <option value="2" @if($invoices[0]->bankId == 2) selected="selected" @else selected="selected" @endif>Santader</option>
                    <option value="3" @if($invoices[0]->bankId == 3) selected="selected" @endif >Cash</option>
                    <option value="4" @if($invoices[0]->bankId == 4) selected="selected" @endif >Cheque</option>
                    <option value="5" @if($invoices[0]->bankId == 5) selected="selected" @endif >Trust Account</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-sm-2 m-l-10">
                <div class="form-group">
                    ...
                    <input class="form-control" name="transactionNumber" required value="{{$invoices[0]->transactionNumber}}" type="text"  autocomplete="off">
                </div>
              </div>
