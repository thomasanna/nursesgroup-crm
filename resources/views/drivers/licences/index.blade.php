...
@section('title','Driver Licences')
@section('content')
<!-- Header Navigation -->
<div class="box box-default">
  <div class="box-header with-border">
    <div class="pull-left">
        <h1 class="box-title">Driver Licences</h1>
    ...
    <div class="pull-right">
        <a href="{{route('drivers.home')}}" class="btn btn-warning">
          ...
          Back</a>
        <a href="{{route('driver.licences.new',encrypt($driver->driverId))}}" class="btn btn-primary">
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive no-padding trainings">
        <table class="table table-striped table-bordered table-hover"
              fetch="{{route('driver.licences.data')}}"
              token="{{ csrf_token() }}"
              driver="{{encrypt($driver->driverId)}}">
          <thead>
            <tr>
              <th style="width=3%;">No</th>
              <th style="width=10%;">Licence Number</th>
              <th style="width=10%;">Date Of Issue</th>
              <th style="width=10%;">Date Of Expiry</th>
...
<script src="{{asset('public/js/pages/drivers/licences/index.js')}}"></script>
@endpush
@push('css')
