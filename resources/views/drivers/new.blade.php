...
<div class="box box-default m-t-10">
  <div class="box-body">
    <div class="pull-left">
        <h4 class="box-title">New Driver</h4>
    </div>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('drivers.save')}}" method="post" enctype="multipart/form-data" >
        {!! csrf_field() !!}
        <div class="box-body">
          <div class='row'>
            <div class='col-sm-3'>
          ...
          <div class='row'>
            <div class='col-sm-2'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="ratePerMile" type="text" />
            ...
            <div class='col-sm-2'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="extraStaffRate" type="text" />
...
<script src="{{asset('public/js/pages/drivers/new.js')}}"></script>
@endpush
@push('css')
