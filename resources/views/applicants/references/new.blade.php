...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      <a href="{{route('applicant.references.home',encrypt($applicant->applicantId))}}" class="btn btn-warning">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('applicant.references.save')}}" method="post" accept="application/pdf, image/*" enctype="multipart/form-data">
        {!! csrf_field() !!}
          ...
          <div class='row'>
            ...
            <div class='col-sm-4'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="position" value="{{ old('position') }}" type="text" />
            ...
            <div class='col-sm-4'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="phone" value="{{ old('position') }}" type="text" />
          ...
          <div class='row'>
            ...
            <div class='col-sm-4'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="email" value="{{ old('position') }}" type="text" />
            ...
            <div class='col-sm-4'>
              <div class='form-group'>
                  <label>Website</label>
                  <input class="form-control" name="website" value="{{ old('position') }}" type="text" />
            ...
            <div class="col-sm-4">
              <div class="form-group">
                  <label>Address</label>
                  <textarea class="form-control" name="address"> {{ old('position') }}</textarea>
          ...
          <div class='row'>
            ...
            <div class='col-sm-4'>
              <div class='form-group'>
                  ...
                  <input class="form-control" name="sentDate" type="text" value="{{ old('position') }}" />
            ...
            <div class='col-sm-4'>
              <div class='form-group'>
                  <label>Sent By</label>
                  <input class="form-control" name="sentBy" type="text" value="{{ old('position') }}"/>
...
<script src="{{asset('public/js/pages/applicants/references/new.js')}}"></script>
@endpush
@push('css')
