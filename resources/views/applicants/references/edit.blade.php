...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      <a href="{{route('applicant.references.home',encrypt($reference->applicantId))}}" class="btn btn-warning">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('applicant.references.update')}}" method="post" accept="application/pdf, image/*" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <input type="hidden" name="referenceId" value="{{encrypt($reference->applicantReferenceId)}}">
        <div class="box-body">
          <div class='row'>
            <div class='col-sm-4'>
