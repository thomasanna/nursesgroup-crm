...
<div class="box box-default m-t-10">
  <div class="box-body">
    ...
    <div class="pull-right">
      <a href="{{route('applicant.dbs.home',encrypt($dbs->applicantId))}}" class="btn btn-warning">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <!-- form start -->
      <form action="{{route('applicant.dbs.update')}}" method="post" accept="application/pdf, image/*" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <input type="hidden" name="applicantId" value="{{encrypt($applicant->applicantId)}}">
        <input type="hidden" name="dbsId" value="{{encrypt($dbs->applicantDbsId)}}">
          ...
          <div class="row beta @if($dbs->dbsType==1 || $dbs->dbsType==3) hidden @endif">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <a href="{{asset('storage/app/applicant/applicant_dbs/'.$dbs->validCertificate)}}" target="_blank" class="btn btn-success">View Certificate</a>
              </div>
            </div>
            @endif
          </div>
...
<script src="{{asset('public/js/pages/applicants/dbs/edit.js')}}"></script>
@endpush
@push('css')
